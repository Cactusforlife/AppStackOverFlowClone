...
public final class QAApp extends Application {
    ...
    private void loadAccessToken() {
        ...
        final String accessTokenJson = sp.getString(PREF_KEY_ACCESS_TOKEN, null);
    ...
    private void saveAccessToken() {
        try {
            ...
            editor.putString(PREF_KEY_ACCESS_TOKEN, accessToken.toJson().toString());
            editor.apply();
        } catch (Exception ex) {
